...
class Main extends Component {
  ...
  _getList = ()=>{
    ...
    const url = `http://119.29.253.88/zerg/public/api/v1/answeredtopic/${this.state.pageIndex}/${this.state.data.orderType}/${this.state.data.grade}/${this.state.data.subject}`
    const that = this
    let arr = []
    console.log(url)
        ...
        if(r.errMsg.indexOf('ok')>-1){
          r.data.map((e)=>{
            arr.push({
              ...
              price:e.price,
              image_url:e.question.speak.image_url,
